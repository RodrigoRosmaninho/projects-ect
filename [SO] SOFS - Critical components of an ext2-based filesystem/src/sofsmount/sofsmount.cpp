 ...
 *  \brief The \b sofs19 suppoting tools.
 *
 *  \author Artur Pereira - 2005--2019
 ...
 *  \ingroup tools
 *  \brief The \b sofs19 mounting program.
 * 
 *  \details 
 *      It provides a simple method to integrate the sofs19 file system into Linux.
 *
 */
...
/* SOFS19 support filename (should be the absolute path) */
 ...
 */
const struct fuse_operations sofs19_fuse_operations = {
...
int main(int argc, char *argv[])
{
    ...
    return fuse_main(fargc, fargv, &sofs19_fuse_operations, NULL);
}
