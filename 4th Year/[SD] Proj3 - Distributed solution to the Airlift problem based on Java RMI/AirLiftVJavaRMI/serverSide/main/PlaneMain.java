	   ...
	   */
	   ...
	   public static void main (String[] args)
	   {
	     ...
	     /* instantiate a barber shop object */
	      ...
	      Plane plane = new Plane (reposStub);                 // barber shop object
	      PlaneInterface planeStub = null;                          // remote reference to the barber shop object
	     ...
	     /* register it with the general registry service */
	      ...
	      String nameEntryObject = "Plane";                   // public name of the barber shop object
	     ...
	     /* wait for the end of operations */
	      ...
	      { while (!end)
	          ...
	          { try
	            ...
	            { GenericIO.writelnString ("PlaneMain main thread was interrupted!");
	            }
	          }
	      }
