...
public class GeneralRepos implements GeneralReposInterface
{
  ...
  public synchronized void updatePassengersInDepartureQueue (int value) throws RemoteException
  {
   ...
   */
   ...
   public synchronized void updatePassengersInPlane (int value) throws RemoteException
   {
   ...
   public synchronized void updatePassengersArrived (int value) throws RemoteException
   {
   ...
   public synchronized void logPassengerCheck(int id) throws RemoteException
   {
   ...
   public synchronized void setPassengerState (int passengerId, int state) throws RemoteException
   {
   ...
   */
    ...
    */
    ...
    {
        nEntities += 1;
        if (nEntities >= ExecConst.E_Repos)
