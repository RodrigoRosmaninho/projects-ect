...
int CheckAES(unsigned int* orig, unsigned int* enc, int size) {
...
//	 Software only
	...
	PrintDataArray(block, 4);

	xil_printf("\n\rChecking result: %s\n\r",
			   CheckAES(clear, block, 4) ? "OK" : "Error");
