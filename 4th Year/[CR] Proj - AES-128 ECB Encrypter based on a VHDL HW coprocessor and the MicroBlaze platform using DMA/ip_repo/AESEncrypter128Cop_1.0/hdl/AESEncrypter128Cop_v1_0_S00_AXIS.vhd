...
entity AESEncrypter128Cop_v1_0_S00_AXIS is
	generic (
...
end AESEncrypter128Cop_v1_0_S00_AXIS;

architecture arch_imp of AESEncrypter128Cop_v1_0_S00_AXIS is
	           ...
	           if (s_ready = '1') then
                    ...
                    for i in 0 to (C_S_AXIS_TDATA_WIDTH/8)-1 loop
                        if (S_AXIS_TSTRB(i) = '1') then
                            readBlock((C_S_AXIS_TDATA_WIDTH-1)-(i*8) downto C_S_AXIS_TDATA_WIDTH-((i+1)*8)) <= S_AXIS_TDATA((C_S_AXIS_TDATA_WIDTH-1)-(i*8) downto C_S_AXIS_TDATA_WIDTH-((i+1)*8));
                        end if;
                    end loop;
                    
                    byteEnable <= S_AXIS_TSTRB;
