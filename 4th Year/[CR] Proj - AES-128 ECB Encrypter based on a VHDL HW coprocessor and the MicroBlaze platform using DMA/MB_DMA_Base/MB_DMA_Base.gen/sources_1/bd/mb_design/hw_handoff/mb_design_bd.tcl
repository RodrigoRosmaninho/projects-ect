...
proc create_root_design { parentCell } {
  ...
  # Create instance: AESEncrypter128Cop_0, and set properties
  set AESEncrypter128Cop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AESEncrypter128Cop:1.0 AESEncrypter128Cop_0 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXIS_TDATA_WIDTH {32} \
   CONFIG.C_S00_AXIS_TDATA_WIDTH {32} \
 ] $AESEncrypter128Cop_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AESEncrypter128Cop_0_M00_AXIS [get_bd_intf_pins AESEncrypter128Cop_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins AESEncrypter128Cop_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
